...
export const itLocale: LocaleMessages = {
  ...
  ui: {
    ...
    subtitle:
      "Carica un export ZIP di SAP Integration Flow e genera documenti multi-template in modalita deterministica o AI-enhanced.",
    tabs: {
      upload: "Upload",
      template: "Template",
      history: "Cronologia",
    ...
    labels: {
      ...
      uploadHint: "Drag & drop ZIP iFlow oppure seleziona manualmente",
